<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"G:\wamp\www\xiangmu\public/../application/admin\view\category\edit.html";i:1509628197;s:71:"G:\wamp\www\xiangmu\public/../application/admin\view\public\header.html";i:1508761816;s:71:"G:\wamp\www\xiangmu\public/../application/admin\view\public\footer.html";i:1486396310;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="page-container">
	<form class="form form-horizontal form-o2o-add" id="form-o2o-add" method="post" action="<?php echo url('category/save'); ?>">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>添加系列名称：</label>
